...
public interface IRLMService {
    ...
    //新增挂号级别
    void RLMaddRegistLevel(String Rcode,String Rname,int Rno,double Rfee,int Rquota,int Rmark) throws SQLException;

    //编辑挂号级别
    RegistLevel RLMSelectupdateRegistLevel(int id) throws SQLException;

    //修改挂号级别
    void RLMUpdatesaveRegistLevel(String Rcode,String Rname,int Rno,Double Rfee,int Rquota,int Rmark) throws SQLException;
