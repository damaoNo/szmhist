...
public interface ISCMService {
    ...
    //新增结算类别保存
    void ScmaddSettleCategory(String Scode,String Sname,int Sno,int Smark) throws SQLException;
    //编辑结算类别
    SettleCategory  ScmselectupdateSettleCategory(int id) throws SQLException;
    //修改结算类
    void ScmupdateSettleCategorySave(String Scode,String Sname,int Sno,int Smark) throws SQLException;
    //删除结算类别
